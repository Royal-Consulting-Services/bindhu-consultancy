...
import { Technology, Blog1, Blog2, Aboutuscont, Implement, Projmanag, Staffaug, Consult, Migrate, Whychoose,  Databasemigrte, Itconsulting, Cloudmigration, Cloudarchitecture, Businessanalytics } from '../images/images';
...
function Home() {
  ...
  return (
    <>
      <Carousel>
        {slides}
        {/* <div className="indicaroter-image">
          {indicators}
         </div> */}
      </Carousel>
      <Container >
        <Row >
          <Col xs={12} md={{ span: 8, offset: 2 }} >
            <ScrollAnimation animateIn='slideInDown' >
              ...
              At BR Group Tech, we are a premier software services company that provides tailor-made cloud solutions to organizations across the United States. Our highly skilled professionals offer comprehensive cloud consulting services to help enterprises boost their productivity like never before.
              ...
              <br /><br />
              Our cloud architects are experienced in helping businesses with reliable and future-ready migrations. This way, you can keep your business operations smooth and stay ahead of your competitors.
            </ScrollAnimation>
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={12} md={6} >
            <ScrollAnimation animateIn='flipInX'>
              At our company, we have a team of highly trained individuals who are experienced in large-scale implementations. This team can help you with the following:
              <ul>
        ...
        <ScrollAnimation animateIn='slideInUp'>
          <Row style={{ borderBottom: "none", marginTop: "50px" }}>
            <Col xs={12} className="col-md-2_5" style={{ padding: "0px", border: "none" }}>
              <Card className='technology-card' >
                <Card.Body>
                  <Card.Title className='technology-title' style={{ textAlign: "center", height: "50px" }}>Implementation</Card.Title>
                  <Card.Text>
            ...
            <Col xs={12} className="col-md-2_5" style={{ padding: "0px", border: "none" }}>
              <Card className='technology-card'>
                <Card.Body>
                  <Card.Title className='technology-title' style={{ textAlign: "center", height: "50px" }}>Project management</Card.Title>
                  <Card.Text>
                    {/* <span className='tech-icon-span'>
            ...
            <Col xs={12} className="col-md-2_5" style={{ padding: "0px" }}>
              <Card className='technology-card'>
                <Card.Body>
                  <Card.Title className='technology-title' style={{ textAlign: "center", height: "50px" }}>Staff Augmentation</Card.Title>
                  <Card.Text>
                    {/* <span className='tech-icon-span'>
            ...
            <Col xs={12} className="col-md-2_5" style={{ padding: "0px", border: "none" }}>
              <Card className='technology-card' >
                <Card.Body>
                  <Card.Title className='technology-title' style={{ textAlign: "center", height: "50px" }}>Consultancy</Card.Title>
                  <Card.Text>
                    {/* <span className='tech-icon-span'>
            ...
            <Col xs={12} className="col-md-2_5" style={{ padding: "0px", border: "none" }}>
              <Card className='technology-card'>
                <Card.Body>
                  <Card.Title className='technology-title' style={{ textAlign: "center", height: "50px" }}>Migration</Card.Title>
                  <Card.Text>
                    {/* <span className='tech-icon-span'>
          ...
          <Row>
            ...
            <Col xs={12} md={4} >
              <Card className='help-cont-card'>
                <Card.Body>
                  <Card.Title>Database Creation & Database Migrations</Card.Title>
                  ...
                  <Button variant="link" onClick={() => homeNavigate("/service")}>read more </Button>
                </Card.Body>
              </Card>
            </Col>
            <Col xs={12} md={4} >
              <Card className='help-cont-card'>
                <Card.Body>
                  ...
                  <Card.Text>
                    <p className='help-content'>
                      Our IT consulting solutions focus on helping you achieve specific business outcomes, through digital strategies, process optimization, and IT infrastructure services.
                      <br />
