...
import { faDatabase, faHeadset, faCloud, faSitemap, faBusinessTime } from '@fortawesome/free-solid-svg-icons';
import { Card, Image } from 'react-bootstrap';
import { Implement, Projmanag, Staffaug, Consult, Migrate, Whychoose, Databasemigrte, Itconsulting, Cloudmigration, Cloudarchitecture, Businessanalytics } from './images/images';
export const SLIDERS = [
    {
        src: Slide1,
        altText: 'Slide 1',
        captionText: 'Value-Added Human Resources and Organizational Development Solutions',
        captionHeader: ''
    },
    {
        src: Slide2,
    ...
    },
    {
        src: Slide3,
        altText: 'Slide 3',
        captionText: 'Business Continuity Plan , Remote Work Policy , Business Recovery Strategies , Workforce Planning , Workplace Health and Safety',
        captionHeader: ' '
    },
    {
        src: Slide4,
...
export const SERVICES = [
    {
        ...
        content: "Our certified cloud engineers provide a tailored database creation & database migrations service that helps cut the time and cost of creating & migrating your data to the public cloud platform. No matter what kind of database you're using - Oracle, SQL server, or something else - we have the knowledge and skills to get it working on the cloud."
    },
    {
        title: "IT Consulting",
        id: "itconsulting",
...
function careerDescribcont() {
    return (
        <>
            <b style={{ display: "block", marginTop: "20px" }}>Keys & Responsibility</b>
            <ul>
                <li> Collaborating with Solutions Architects, Business Analysts,
                    Project Leads, DevOps, Security Engineers & Scrum </li>
                ...
                <li>Creating integrations with headless backend systems and third-party SaaS products</li>
                <li>Performing technical analysis of business requirements</li>
                <li>Providing bullet-proof functionality in cooperation with the QA team</li>
            </ul>
            <b style={{ display: "block", marginTop: "20px" }}>Key Requirements/Minimum Qualifications :</b>
            <ul>
                <li>  Have 4+ years of professional experience in Frontend Web application development
                    Are experienced in working with Angular 2+ with TypeScript</li>
                <li>Have Experience in building responsive web applications using HTML5, CSS, JavaScript</li>
                <li>Have Experience working in an Agile environment along with JIRA, Confluence, Bitbucket and Git</li>
                <li>Have experience with ngrx, rxjs</li>
                <li>Have good knowledge of CSS/SCSS</li>
                <li>Have experience with Unit testing (ideally Jasmine/Karma) or E2E testing (ideally Cypress)</li>
                <li>Speak English fluently</li>
            </ul>
            <b style={{ display: "block", marginTop: "20px" }}> Preferred Qualifications/Skills/Experience :</b>
            <ul>
